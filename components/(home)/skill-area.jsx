                    ...
                    <div className="col-xl-5 col-lg-5  col-md-12  col-sm-12 col-12">
                        <div className="position-relative">
                            <div className="title mb-50">
                                ...
                                <p>
                                    As a Senior Android Developer, I continuously refine my expertise across diverse technical domains. From robust Software Development and System Applications to Web Development and Data Administration, my versatile skill set allows me to deliver comprehensive, high-quality digital solutions.
                                </p>
                            </div>
                        </div>
                    </div>
