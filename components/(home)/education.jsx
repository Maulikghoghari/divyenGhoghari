                    ...
                    <div className="col-xl-6 col-lg-6  col-md-12 col-sm-12 col-12">
                        <div className="position-relative">
                            <div className="title">
                                ...
                                <p>
                                    My academic journey in Computer Applications has provided
                                    me with a strong technical foundation, equipping me to build
                                    highly scalable and user-centric software solutions.
                                </p>
                            </div>
                        </div>
