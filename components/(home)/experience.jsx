                            ...
                            <div className="experience-margin mt-160 pb-80 pl-100 mb-50">
                                <div className="position-relative">
                                    <div className="title">
                                        ...
                                        <p>
                                            A highly skilled Senior Android Developer with over 11 Month of experience building intuitive, userfriendly mobile applications. Proficient in Java and Kotlin, with expertise in MVVM architecture,
                                            Retrofit.
